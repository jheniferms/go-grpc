...
func (x *MaxRequest) GetNumber() uint32 {
	if x != nil {
		return x.Number
	}
	return 0
...
func (x *MaxResponse) GetResult() uint32 {
	if x != nil {
		return x.Result
	}
	return 0
...
var file_max_proto_rawDesc = []byte{
	...
	0x01, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x06, 0x6e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x22, 0x25, 0x0a,
	...
	0x6f, 0x6d, 0x2f, 0x6a, 0x68, 0x65, 0x6e, 0x69, 0x66, 0x65, 0x72, 0x6d, 0x73, 0x2f, 0x67, 0x6f,
